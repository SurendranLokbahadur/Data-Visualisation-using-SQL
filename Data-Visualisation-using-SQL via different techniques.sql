...
SELECT FLOOR(Sales) AS Sales_Range, 
COUNT(*) AS Frequency
FROM sales_data
GROUP BY FLOOR(Sales)
...
SELECT Product_Name, Order_Date, SUM(Sales) AS Total_Sales
FROM sales_data
...
9. DATA_MAP: Show total sales by region.
...
10. HEAT_MAP: Show sales amount by product and region.
